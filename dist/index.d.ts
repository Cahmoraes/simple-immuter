declare const _default: {
    produce: {
        ...
        <T_1 extends object | Map<unknown, unknown> | Set<unknown> | unknown[] | Date>(baseState: T_1, producer: (draftState: T_1) => void | T_1, config: {
            freeze: boolean;
        }): Readonly<Readonly<T_1>>;
        <T_2 extends object | Map<unknown, unknown> | Set<unknown> | unknown[] | Date>(baseState: T_2, producer: (draftState: T_2) => void | T_2): Readonly<Readonly<T_2>>;
    };
